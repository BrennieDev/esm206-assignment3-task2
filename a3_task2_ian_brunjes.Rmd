...
```{r}
# Your code here: 
some_dates <- c(01011990, 02222002, 3141596) # Creates a vector of dates w/o spaces
some_dates_converted <- mdy(some_dates) # Converts to Date, stores as my_dates_converted
